...
def check_crossover(df, symbol, timeframe):
    ...
    # 1. সেটআপ: থ্রেশহোল্ড 0.5% থেকে 0.1% এ পরিবর্তন করা হলো
...
def main():
    # --- চূড়ান্ত পরীক্ষা: সংযোগ সফল কিনা তা যাচাই ---
    send_pushbullet_notification("🚨 চূড়ান্ত পরীক্ষা: সংযোগ সফল", "যদি এই বার্তাটি পান, তাহলে Pushbullet এবং কোড এক্সিকিউশন ঠিক আছে।")
    # ----------------------------------------------------
